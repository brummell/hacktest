			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="cpuavguseperc" title="${message(code: 'monitor.cpuavguseperc.label', default: 'Cpuavguseperc')}" />
					
						<g:sortableColumn property="driveuseperc" title="${message(code: 'monitor.driveuseperc.label', default: 'Driveuseperc')}" />
					
						<g:sortableColumn property="memuseperc" title="${message(code: 'monitor.memuseperc.label', default: 'Memuseperc')}" />
					
						<g:sortableColumn property="netrxtot" title="${message(code: 'monitor.netrxtot.label', default: 'Netrxtot')}" />
					
						<g:sortableColumn property="nettxtot" title="${message(code: 'monitor.nettxtot.label', default: 'Nettxtot')}" />
